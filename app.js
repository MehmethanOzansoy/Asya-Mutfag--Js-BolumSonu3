...
// allButton.setAttribute('type', 'button')
// container.appendChild(koreaButton);
...
// allButton.setAttribute('type', 'button')
// container.appendChild(japanButton);
...
// allButton.setAttribute('type', 'button')
// container.appendChild(chinaButton);

// let category1 = []
// const type1 = menu.filter((item) => item.category === 'Korea').map(item => category1.push(item))
// // console.log(type1)
// // console.log(category1)


// let category2 = []
// const type2 = menu.filter((item) => item.category === 'Japan').map(item => category2.push(item))
// // console.log(category2)

// let category3 = []
// const type3 = menu.filter((item) => item.category === 'China').map(item => category3.push(item))
// // console.log(category3)

// const subMenu = document.querySelector(".section-center row");
